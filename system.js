...
router.get("/health", authenticate, async (req, res) => {
  try {
    ...
    console.error("System health check error:");
    res.status(500).json({
      success: false,
...
router.get("/info", authenticate, async (req, res) => {
  try {
    ...
    console.error("System info error:");
    res.status(500).json({
      success: false,
...
router.get("/cpu", authenticate, async (req, res) => {
  try {
    ...
    console.error("CPU metrics error:");
    res.status(500).json({
      success: false,
...
router.get("/memory", authenticate, async (req, res) => {
  try {
    ...
    console.error("Memory metrics error:");
    res.status(500).json({
      success: false,
...
router.get("/online-users", authenticate, async (req, res) => {
  try {
    ...
    console.error("Online users count error:");
    res.status(500).json({
      success: false,
